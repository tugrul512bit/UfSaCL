...
#include<vector>
#include<iostream>
// polynomial curve-fitting sample with 200000 data points & 4 polynomial coefficients
// normally this would take too much time on just single-thread version but it completes in 1.6 seconds with RTX4070 + RTX4060ti
int main()
{
    try
    {
